...
class Station(models.Model):
    ...
    def refresh_streams(self):
        ...
        Stream.objects.filter(station=self).exclude(url__in=urls.values()).delete()
...
class Stream(models.Model):
    ...
    def clean(self):
        ...
        if self.default:
            Stream.objects.filter(station=self.station).exclude(id=self.id).update(default=False)

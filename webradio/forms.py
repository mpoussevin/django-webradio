...
class StationForm(forms.ModelForm):
    default_stream = forms.ModelChoiceField(queryset=Stream.objects.none(), required=False)
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance.pk:
            self.fields['default_stream'].queryset = Stream.objects.filter(station=self.instance)
